    ...
    >
      <div className="w-full max-w-sm rounded-2xl border border-gray-700 bg-gray-900 shadow-2xl">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          <h2 className="text-sm font-semibold text-white uppercase tracking-wide">Edit Project</h2>
          <button
            onClick={onClose}
        ...
        {/* Body */}
        <form id="edit-project-form" onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
          {error && (
          ...
          <div className="space-y-1">
            <label className="block text-xs text-gray-400">Project Name</label>
            <input
              className={INPUT}
              required
              value={name}
